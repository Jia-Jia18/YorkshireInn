...
----------------------------------------
Author: Christopher Pegoli
File:  blue-booking.php
Version: 1.0
...
$grandTotal1 = $_SESSION['grandTotal1'];
...
$sql = "INSERT INTO reservation(BookingDate, CheckIn, CheckOut, NumGuests, SpecialReq, TotalPayment, TotalDeposit, RoomID, TravelerID, PaymentID) 
        VALUES ('$insertTime', '$checkIn', '$checkOut', '$numGuests', '$SpecialReq', '$grandTotal1', '$deposit1', '$RoomID', '$travID', '$payID')";
$result = mysqli_query($conn, $sql);
...
// Redirects the customer to blue-confirmation.php and passes the reservation ID to the page as well as puts it in the URL
header("Location: blue-confirmation.php?resID=$resID");
?>

...
$sql = "SELECT SUM(room4Price) AS price FROM price WHERE priceDate >= '$checkIn' AND priceDate < '$checkOut'";
$result = mysqli_query($conn, $sql);
$row = $result->fetch_assoc();
$price = $row['price'];

// SQL query that gets the price of the room and sets it to a variable 
$roomPrice = "SELECT room4Price AS roomPrice FROM price WHERE priceDate = '$checkIn'";
...
?>
        <h3 class='resDetails'>Confirmation of your reservation of the Lodge Suite between:</h3>

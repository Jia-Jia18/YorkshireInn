...
// Calculates guest fee (for this room there isn't one
$totalGuestFee = $numGuests * 0;
...
$sql1 = "SELECT SUM(room1Price) AS price FROM price WHERE priceDate >= '$checkIn' AND priceDate < '$checkOut'";
$result1 = mysqli_query($conn, $sql1);
$row1 = $result1->fetch_assoc();
$price1 = $row1['price'];

// SQL query that gets the price of the room and sets it to a variable 
$roomPrice1 = "SELECT room1Price AS roomPrice FROM price WHERE priceDate = '$checkIn'";
$roomResult1 = mysqli_query($conn, $roomPrice1);
$roomPriceRow1 = $roomResult1->fetch_assoc();
$roomPrice1 = $roomPriceRow1['roomPrice'];

// Calculates the cost of the rooms for all nights with the guest fee
$totalWGuestFee1 = $totalGuestFee1 + $price1;

// Calcutes the sales tax
$salesTax1 = $totalWGuestFee1 * .08;

// Adds the sales tax to calculate to total cost with fees
$grandTotal1 = $totalWGuestFee1 + $salesTax1;

// Misc. SESSION variables for functionality
$_SESSION['grandTotal1'] = $grandTotal1;
?>
<div class="grid-wrapper">
    <div class='resDetails'>
        ...
        <div class='room'>
            <div class='row'>
                ...
                <div class='col' id='paymentWindow'>
                    <img src='assets/img/blue.jpg' alt='Blue Room Bed' class='payImg'>
                </div>
            </div>
            <div class='row'>
                <div class='roomInfo'>
                    <div class='row' id='infoRow'>
                        ...
                        <div class='col' id='infoCol'>
                            ...
                            <p>$<?php echo number_format($roomPrice1, 2); ?>/Night</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class='roomTotal'>
                    ...
                    <p>$<?php echo number_format($grandTotal1, 2); ?></p>
                </div>
            </div>
    ...
    <div class='summary'>
        <table>
            ...
            <tr>
                ...
                <td>$<?php echo number_format($roomPrice1, 2); ?></td>
                <td>$<?php echo number_format($price1, 2); ?></td>
            </tr>
            <tr>
                <td>NYS Sales Tax (8%)</td>
                <td>$<?php echo number_format($totalWGuestFee1, 2); ?> x .08</td>
                <td>$<?php echo number_format($salesTax1, 2); ?></td>
                <td>$<?php echo number_format($grandTotal1, 2); ?></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
    ...
    <div class='guestInfo'>
        <form method="POST" action="blue-booking.php">
            <div class="row">
                <div class="formcol1">

...
$grandTotal3 = $_SESSION['grandTotal3'];
...
$sql = "INSERT INTO reservation(BookingDate, CheckIn, CheckOut, NumGuests, SpecialReq, TotalPayment, TotalDeposit, RoomID, TravelerID, PaymentID) 
        VALUES ('$insertTime', '$checkIn', '$checkOut', '$numGuests', '$SpecialReq', '$grandTotal3', '$deposit3', '$RoomID', '$travID', '$payID')";
$result = mysqli_query($conn, $sql);

// SQL query blocks the availability of the room between the check in and check out dates
$sql = "UPDATE isAvailable SET isAvailableBool3 = 0 WHERE isAvailableDate BETWEEN '" . $checkIn . "' AND '" . $checkOut . "'";
$result = mysqli_query($conn, $sql);
...
// Redirects the customer to rose-confirmation.php and passes the reservation ID to the page as well as puts it in the URL
header("Location: rose-confirmation.php?resID=$resID");
?>

...
$sql4 = "SELECT SUM(room4Price) AS price FROM price WHERE priceDate >= '$checkIn' AND priceDate < '$checkOut'";
$result4 = mysqli_query($conn, $sql4);
$row4 = $result4->fetch_assoc();
$price4 = $row4['price'];

// SQL query that gets the price of the room and sets it to a variable 
$roomPrice4 = "SELECT room4Price AS roomPrice FROM price WHERE priceDate = '$checkIn'";
$roomResult4 = mysqli_query($conn, $roomPrice4);
$roomPriceRow4 = $roomResult4->fetch_assoc();
$roomPrice4 = $roomPriceRow4['roomPrice'];

// Calculates the cost of the rooms for all nights with the guest fee and sales tax
if ($numGuests > 2) {
    $totalGuestFee4 = ($numGuests - 2) * 30;
    $totalWGuestFee4 = $price4 + $totalGuestFee4;
    $salesTax4 = $totalWGuestFee4 * .08;
} else {
    $totalWGuestFee4 = $price4;
    $salesTax4 = $price4 * .08;
}

// Adds the sales tax to calculate to total cost with fees
$grandTotal4 = $totalWGuestFee4 + $salesTax4;

// Misc. SESSION variables for functionality
$_SESSION['grandTotal4'] = $grandTotal4;
?>
<div class="grid-wrapper">
    <div class='resDetails'>
        ...
        <div class='room'>
            <div class='row'>
                ...
                <div class='col' id='paymentWindow'>
                    <img src='assets/img/lodge.png' alt='Lodge Suite' class='payImg'>
                </div>
            </div>
            <div class='row'>
                <div class='roomInfo'>
                    <div class='row' id='infoRow'>
                        ...
                        <div class='col' id='infoCol'>
                            ...
                            <p>$<?php echo number_format($roomPrice4, 2); ?>/Night</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class='roomTotal'>
                    ...
                    <p>$<?php echo number_format($grandTotal4, 2); ?></p>
                </div>
            </div>
    ...
    <div class='summary'>
        <table>
            ...
            <tr>
                ...
                <td>$<?php echo number_format($roomPrice4, 2); ?></td>
                <td>$<?php echo number_format($price4, 2); ?></td>
            </tr>
            <tr>
                <td>Guest fee ($30 per guest)</td>
                <td><?php echo $numGuests; ?></td> <!-- for testing purposes, this is only needed on rose/lodge -->
                <td>$<?php echo number_format($totalGuestFee4, 2); ?></td>
                <td>$<?php echo number_format($totalWGuestFee4, 2); ?></td>
            </tr>
       <!-- <tr>
                <td>Guest 1</td>
                <td>6</td>
            ...
            <tr>
                ...
                <td>$<?php echo number_format($totalWGuestFee4, 2); ?> x .08</td>
                <td>$<?php echo number_format($salesTax4, 2); ?></td>
                <td>$<?php echo number_format($grandTotal4, 2); ?></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
    ...
    <div class='guestInfo'>
        <form method="POST" action="lodge-booking.php">
            <div class="row">
                <div class="formcol1">
